...
public class StringUtility {
    private static ADFLogger logger = ADFLogger.createADFLogger(StringUtility.class);
     ...
     * @return HashSet
     */
    public static HashSet<String> getSetFromString(String valueStr, String delimiter){
    ...
    /**
     * This method will return the All Map values as String value with delimiter.
     * @param map
     * @param delimiter
     * @return String
     */
    public static String getValueStringFromMap(Map<?,?> map, String delimiter){
        StringBuilder sb = new StringBuilder();
        if(map != null){
            Iterator<?> itr = map.keySet().iterator();
            for (int i = 0; itr.hasNext(); i++) {
                if (i == 0) {
                    sb.append(map.get(itr.next()));
        
                } else {
                    sb.append(delimiter);
                    sb.append(map.get(itr.next()).toString());
                }
            }            
        }
        return sb.toString();
