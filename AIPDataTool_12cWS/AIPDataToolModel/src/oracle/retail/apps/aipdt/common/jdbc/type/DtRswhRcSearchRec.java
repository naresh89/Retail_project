 ...
 * Oracle Type Name  : DT_RSWH_RC_SEARCH_REC
 * Owned by          : SYSTEM
 * Requested Schema  : SYSTEM
 * Requested DB URL  : jdbc:oracle:thin:@localhost:1521:XE
 * Requested DB User : system
 *******************************************************/
public class DtRswhRcSearchRec implements ORAData, ORADataFactory, OracleTypeAdapter {
    public static final String _SQL_NAME = "DT_RSWH_RC_SEARCH_REC";
    ...
    protected static final DtRswhRcSearchRec _DtRswhRcSearchRecFactory = new DtRswhRcSearchRec();
    public static ORADataFactory getORADataFactory() {
        return _DtRswhRcSearchRecFactory;
    }

    public DtRswhRcSearchRec() {
    ...
    protected ORAData create(DtRswhRcSearchRec o, Datum d, int sqlType) throws SQLException {
        if (d == null)
            return null;
        if (o == null)
            o = new DtRswhRcSearchRec();
